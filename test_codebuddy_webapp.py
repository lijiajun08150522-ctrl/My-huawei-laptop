...
def test_codebuddy_website():
    """测试 CodeBuddy.ai 官网功能"""

    with sync_playwright() as p:
        print("=" * 60)
        print("开始测试 CodeBuddy.ai 官网")
        print("=" * 60)
        ...
        try:
            ...
            page.goto('https://codebuddy.ai', timeout=30000)
        ...
        try:
            ...
            for inp in inputs[:3]:
                name = inp.get_attribute('name') or inp.get_attribute('placeholder') or "[未命名]"
                print(f"       - {name}")
        except Exception as e:
            print(f"    ✗ 输入框查找失败: {e}")
        ...
        try:
            ...
            page.screenshot(path='d:/SummerProject/codebuddy_screenshot.png', full_page=True)
            print(f"    ✓ 截图已保存到: codebuddy_screenshot.png")
        except Exception as e:
            print(f"    ✗ 截图保存失败: {e}")
...
if __name__ == "__main__":
    success = test_codebuddy_website()
